...
class Example:
    def __init__(self, viewer, verbose=False):
        ...
        # Force logging
        self.log_data = []  # List to store [time, sphere_fz, cube_fz, sphere_z, sphere_vz]
    ...
    def log_forces(self):
        """Log force data every frame for CSV export"""
        # Sphere forces
        ...
        # Soft cube average height
        particle_q = self.state_0.particle_q.numpy()
        cube_avg_z = np.mean(particle_q[:, 2])
        
        # Store: [time, sphere_fz, sphere_f_mag, cube_fz, cube_f_mag, sphere_z, sphere_vz, cube_avg_z]
